...
import udf.Consts.{FILTER_CATALOG_SALES_WHERE_PROFIT_NEGATIVE, FILTER_CATALOG_SALES_WHERE_PROFIT_NEGATIVE_AND_YEAR_AFTER_2000, FILTER_CATALOG_SALES_WHERE_YEAR_AFTER_2000}
